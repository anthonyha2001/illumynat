    ...
    <div className="space-y-6">
      ...
      {version && (
        <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="flex items-center gap-3">
                  {version.status !== "ACTIVE" && (
                    <button
                      ...
                      disabled={loading}
                      className="font-body text-[10px] tracking-widest uppercase text-success hover:underline disabled:opacity-50"
                    >
                      Set Active
                    </button>
                  )}
          ...
          {/* Right — material stock preview */}
          <div className="bg-surface border border-border-subtle p-6 h-fit space-y-4">
            <p className="font-body text-[11px] font-medium tracking-[0.15em] uppercase text-text-muted">
              Stock Preview
            </p>
            {version.ingredients.length === 0 ? (
