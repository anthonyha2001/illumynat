  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden z-[2]">
        ...
        {/* ── SPARKLES ✦ ── */}
        {/* Large — top left signature sparkle (animated) */}
        <svg viewBox="0 0 24 24" className="absolute top-20 left-10 md:left-20 w-7 h-7 text-white/[0.28] animate-sparkle">
          <path d="M12 0 L13.4 10.6 L24 12 L13.4 13.4 L12 24 L10.6 13.4 L0 12 L10.6 10.6 Z" fill="currentColor"/>
        </svg>
        {/* Medium — upper center (offset timing) */}
        <svg viewBox="0 0 24 24" className="absolute top-10 left-[42%] w-4 h-4 text-white/[0.18] animate-sparkle animation-delay-300" style={{ animationDelay: "1.4s" }}>
          <path d="M12 0 L13.4 10.6 L24 12 L13.4 13.4 L12 24 L10.6 13.4 L0 12 L10.6 10.6 Z" fill="currentColor"/>
        </svg>
        {/* Medium — left mid */}
        <svg viewBox="0 0 24 24" className="absolute top-[38%] left-8 w-4 h-4 text-white/[0.15] animate-sparkle-slow" style={{ animationDelay: "2.8s" }}>
          <path d="M12 0 L13.4 10.6 L24 12 L13.4 13.4 L12 24 L10.6 13.4 L0 12 L10.6 10.6 Z" fill="currentColor"/>
        </svg>
        {/* Small — far left lower */}
        <svg viewBox="0 0 24 24" className="absolute top-[58%] left-5 w-3 h-3 text-white/[0.12] animate-sparkle-slow" style={{ animationDelay: "0.7s" }}>
          <path d="M12 0 L13.4 10.6 L24 12 L13.4 13.4 L12 24 L10.6 13.4 L0 12 L10.6 10.6 Z" fill="currentColor"/>
        </svg>
        {/* Small — right mid */}
        <svg viewBox="0 0 24 24" className="absolute top-[44%] right-8 md:right-14 w-3.5 h-3.5 text-white/[0.11] animate-sparkle" style={{ animationDelay: "3.1s" }}>
          <path d="M12 0 L13.4 10.6 L24 12 L13.4 13.4 L12 24 L10.6 13.4 L0 12 L10.6 10.6 Z" fill="currentColor"/>
        </svg>
        {/* Tiny — bottom center */}
        <svg viewBox="0 0 24 24" className="absolute bottom-40 left-[48%] w-3 h-3 text-white/[0.10] animate-sparkle-slow" style={{ animationDelay: "2.0s" }}>
          <path d="M12 0 L13.4 10.6 L24 12 L13.4 13.4 L12 24 L10.6 13.4 L0 12 L10.6 10.6 Z" fill="currentColor"/>
        </svg>
        {/* Tiny — upper right area */}
        <svg viewBox="0 0 24 24" className="absolute top-16 right-36 md:right-52 w-2.5 h-2.5 text-white/[0.13] animate-sparkle" style={{ animationDelay: "4.5s" }}>
          <path d="M12 0 L13.4 10.6 L24 12 L13.4 13.4 L12 24 L10.6 13.4 L0 12 L10.6 10.6 Z" fill="currentColor"/>
        </svg>
