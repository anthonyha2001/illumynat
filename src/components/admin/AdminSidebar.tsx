  ...
  return (
    <aside className="w-56 shrink-0 bg-bg-darker min-h-screen flex flex-col">
      ...
      <div className="px-6 py-5 border-b border-white/5">
        ...
        <p className="font-body text-[10px] tracking-widest uppercase text-white/30 mt-0.5">
          Admin Portal
        </p>
      </div>
      ...
      <div className="px-3 py-4 border-t border-white/5 space-y-0.5">
        <Link
          href="/"
          className="flex items-center gap-3 px-3 py-2.5 font-body text-[11px] tracking-[0.08em] uppercase text-white/30 hover:text-white/60 transition-colors duration-150"
        >
        ...
        <form action={signOut}>
          <button
            type="submit"
            className="w-full flex items-center gap-3 px-3 py-2.5 font-body text-[11px] tracking-[0.08em] uppercase text-white/30 hover:text-error transition-colors duration-150"
          >
