...
export function orderConfirmationHtml(d: OrderConfirmationData): string {
  ...
  return `<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Order Confirmed — LUMYNAT</title></head>
