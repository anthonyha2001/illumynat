...
export function giftCardIssuedHtml(d: GiftCardIssuedData): string {
  ...
  return `<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Your ILLUMYNAT Gift Card</title></head>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#FDFAF6;border:1px solid #EDE9E3;">
        ...
        <tr>
          <td style="padding:40px;">
            ...
            <p style="margin:0 0 32px;font-size:14px;color:#8A5A62;font-family:sans-serif;text-align:center;">Enter this code at checkout on illumynat.com to redeem your gift.</p>

            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center">
                  <a href="${process.env.NEXT_PUBLIC_SITE_URL ?? "https://illumynat.com"}/shop" style="display:inline-block;padding:14px 32px;background:#B8972A;color:#2D0A12;font-family:sans-serif;font-size:11px;letter-spacing:0.15em;text-transform:uppercase;text-decoration:none;">
                    Shop Now
                  </a>
                </td>
              </tr>
...
export function giftCardIssuedText(d: GiftCardIssuedData): string {
  ...
  return `Your ILLUMYNAT Gift Card\n\n${from}Your $${d.amount.toFixed(2)} gift card code is:\n\n${d.code}\n\nUse it at checkout on illumynat.com.\n\n— ILLUMYNAT`;
}
